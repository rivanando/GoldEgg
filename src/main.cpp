...
#if defined(NDEBUG)
#error "Goldegg cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ugoldegg) are considered zero fee (for relaying and mining)
