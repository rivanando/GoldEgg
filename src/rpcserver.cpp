...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Goldegg server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Goldegg features */
        {"goldegg", "masternode", &masternode, true, true, false},
        {"goldegg", "listmasternodes", &listmasternodes, true, true, false},
        {"goldegg", "getmasternodecount", &getmasternodecount, true, true, false},
        {"goldegg", "masternodeconnect", &masternodeconnect, true, true, false},
        {"goldegg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"goldegg", "masternodedebug", &masternodedebug, true, true, false},
        {"goldegg", "startmasternode", &startmasternode, true, true, false},
        {"goldegg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"goldegg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"goldegg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"goldegg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"goldegg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"goldegg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"goldegg", "mnbudget", &mnbudget, true, true, false},
        {"goldegg", "preparebudget", &preparebudget, true, true, false},
        {"goldegg", "submitbudget", &submitbudget, true, true, false},
        {"goldegg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"goldegg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"goldegg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"goldegg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"goldegg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"goldegg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"goldegg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"goldegg", "checkbudgets", &checkbudgets, true, true, false},
        {"goldegg", "mnsync", &mnsync, true, true, false},
        {"goldegg", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> goldegg-cli " + methodname + " " + args + "\n";
}
