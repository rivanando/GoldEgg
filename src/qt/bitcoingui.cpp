                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Goldegg Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and goldegg: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Goldegg Core"), this);
    aboutAction->setStatusTip(tr("Show information about Goldegg Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Goldegg"));
    ...
    openAction->setStatusTip(tr("Open a goldegg: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Goldegg Core help message to get a list with possible Goldegg command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Goldegg Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Goldegg network", "", count));
}
...
{
    QString strTitle = tr("Goldegg Core"); // default title
