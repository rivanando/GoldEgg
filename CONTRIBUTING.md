Contributing to Goldegg Core
==================================

The Goldegg Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Goldegg Core project, and is not to be
confused with overall Goldegg Network Protocol consensus changes.

Whether a pull request is merged into Goldegg Core rests with the project merge
...
Patches that change Goldegg consensus rules are considerably more involved than
...
Where a patch set proposes to change the Goldegg consensus, it must have been
...
about:
  ...
  - It may be because the changes you are suggesting do not appeal to people. Rather than
    ...
    [developer notes](doc/developer-notes.md), is dangerous or ingecure, is messily written, etc.
...
The project leader is the release manager for each Goldegg Core release.
