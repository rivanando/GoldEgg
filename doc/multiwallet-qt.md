...
In order to support loading of multiple wallets in goldegg-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is goldegg.cpp.
...
Changes to goldegg.cpp
----------------------
goldegg.cpp is the entry point into goldegg-qt, and as such, will require some minor modifications to provide hooks for
