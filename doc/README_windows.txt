...
Intro
-----
Goldegg (GEC) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Goldegg utilizes an energy efficient proof-of-stake algorithm,
can be mined on any computer, and will never require specialized mining equipment.

Setup
-----
Unpack the files into a directory and run goldegg-qt.exe.

Goldegg Core is the original Goldegg client and it builds the backbone of the network.
However, it downloads and stores the entire history of Goldegg transactions;
