...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GDE, _12_ times over the course of a year totaling _24000_ GDE.
...
When block `1000000` is reached you'll receive a payment for `1200` GDE.
