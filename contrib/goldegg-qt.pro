...
RESOURCES += src/qt/goldegg.qrc src/qt/goldegg_locale.qrc

TRANSLATIONS += src/qt/locale/goldegg_bg.ts \
                src/qt/locale/goldegg_de.ts \
                src/qt/locale/goldegg_en.ts \
                src/qt/locale/goldegg_es.ts \
                src/qt/locale/goldegg_fi.ts \
                src/qt/locale/goldegg_fr.ts \
                src/qt/locale/goldegg_it.ts \
                src/qt/locale/goldegg_ja.ts \
                src/qt/locale/goldegg_pl.ts \
                src/qt/locale/goldegg_pt.ts \
                src/qt/locale/goldegg_ru.ts \
                src/qt/locale/goldegg_sk.ts \
                src/qt/locale/goldegg_sv.ts \
                src/qt/locale/goldegg_vi.ts \
                src/qt/locale/goldegg_zh_CN.ts \
                src/qt/locale/goldegg_zh_TW.ts
